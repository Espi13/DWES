...
<html>
  ...
  <body>
    <p>Introduce el numero de terminos que quiere calcular de la serie Fibonacci</p>
    <form  action="T3EJ12_2.php" method="post">
      <label>N. Terminos <input type="text" name="num"></label>
